...
For a Strava-style app, [managed OAuth](docs/guide/oauth.md#sign-in-and-connect-provider-access)
...
keys, and SQL connection; see the [runnable example](examples/auth/src/strava-app.ts).
